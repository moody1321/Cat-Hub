...
local RayfieldLibrary = {
	...
	Theme = {
		...
		Ocean = {
            TextColor = Color3.fromRGB(230, 220, 250), -- Light lavender for text
        
            Background = Color3.fromRGB(30, 10, 40), -- Deep dark purple
            Topbar = Color3.fromRGB(40, 20, 50), -- Slightly lighter dark purple
            Shadow = Color3.fromRGB(20, 5, 30), -- Very dark purple for shadows
        
            NotificationBackground = Color3.fromRGB(35, 15, 45), -- Dark purple for notifications
            NotificationActionsBackground = Color3.fromRGB(230, 220, 250), -- Light lavender for notification actions
        
            TabBackground = Color3.fromRGB(50, 30, 60), -- Medium dark purple for tabs
            TabStroke = Color3.fromRGB(60, 40, 70), -- Slightly lighter purple for tab strokes
            TabBackgroundSelected = Color3.fromRGB(120, 80, 140), -- Brighter purple for selected tabs
            TabTextColor = Color3.fromRGB(210, 200, 230), -- Light lavender for tab text
            SelectedTabTextColor = Color3.fromRGB(30, 10, 40), -- Dark purple for selected tab text
        
            ElementBackground = Color3.fromRGB(40, 20, 50), -- Dark purple for elements
            ElementBackgroundHover = Color3.fromRGB(50, 30, 60), -- Slightly lighter on hover
            SecondaryElementBackground = Color3.fromRGB(35, 15, 45), -- Dark purple for secondary elements
            ElementStroke = Color3.fromRGB(60, 40, 70), -- Purple for element strokes
            SecondaryElementStroke = Color3.fromRGB(55, 35, 65), -- Slightly darker purple for secondary strokes
        
            SliderBackground = Color3.fromRGB(50, 20, 70), -- Dark purple for slider background
            SliderProgress = Color3.fromRGB(80, 40, 100), -- Brighter purple for slider progress
            SliderStroke = Color3.fromRGB(90, 50, 110), -- Even brighter purple for slider stroke
        
            ToggleBackground = Color3.fromRGB(40, 20, 50), -- Dark purple for toggle background
            ToggleEnabled = Color3.fromRGB(100, 50, 120), -- Brighter purple for enabled toggle
            ToggleDisabled = Color3.fromRGB(70, 50, 80), -- Muted purple for disabled toggle
            ToggleEnabledStroke = Color3.fromRGB(110, 60, 130), -- Bright purple for enabled toggle stroke
            ToggleDisabledStroke = Color3.fromRGB(80, 60, 90), -- Muted purple for disabled toggle stroke
            ToggleEnabledOuterStroke = Color3.fromRGB(70, 30, 90), -- Darker purple for outer stroke (enabled)
            ToggleDisabledOuterStroke = Color3.fromRGB(60, 40, 70), -- Muted purple for outer stroke (disabled)
        
            DropdownSelected = Color3.fromRGB(50, 30, 60), -- Medium dark purple for selected dropdown
            DropdownUnselected = Color3.fromRGB(40, 20, 50), -- Dark purple for unselected dropdown
        
            InputBackground = Color3.fromRGB(40, 20, 50), -- Dark purple for input background
            InputStroke = Color3.fromRGB(60, 40, 70), -- Purple for input stroke
            PlaceholderColor = Color3.fromRGB(140, 120, 160) -- Muted lavender for placeholder text
		},
